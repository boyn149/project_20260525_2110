...
6. **บันทึก Metadata:** บันทึก `task_id`, `artifact_id`, `prompt`, `status` ใน `pic_{book_code}/phase4_metadata.json`
7. **ดาวน์โหลด:** `list()` + `download_infographic()` → บันทึกใน `pic_{book_code}/`
8. **Upload Git:**
```bash
...
3.  **Delay:** รอ 10 วินาที
4.  **Loop:** ทำรูปถัดไปจนครบทุก prompt ในทุกเล่ม
...
6.  กฎการบันทึกไฟล์ใน folder `book/`:
    ...
    -   ตัด citation ออกทั้งหมด เช่น [1], [1 - 2], [1 , 3], [i]
...
### Example
```pahse4_metadata.json
{
  "book_code": "book1",
  "book_title": "เสน่ห์เงียบทรงพลัง: Passive Attractive ฉบับผู้หญิง INFJ",
  "total_images": 3,
  "created_at": "2026-05-26T19:30:00",
  "images": [
    {
      "sequence": 1,
      "prompt": "A minimal 16:8 informational infographic about INFJ Cognitive Functions (Ni and Fe)...",
      "task_id": "abc123def456",
      "artifact_id": "art789xyz012",
      "filename": "infographic_book1_1.png",
      "status": "completed",
      "github_url": "https://raw.githubusercontent.com/user/repo/main/book/book_book1/pic_book1/infographic_book1_1.png",
      "created_at": "2026-05-26T19:31:23",
      "completed_at": "2026-05-26T19:36:45"
    },
    {
      "sequence": 2,
      "prompt": "Create a simple diagram showing \"The INFJ Door Slam\" process (4 stages)...",
      "task_id": "ghi345jkl678",
      "artifact_id": "art901mno234",
      "filename": "infographic_book1_2.png",
      "status": "completed",
      "github_url": "https://raw.githubusercontent.com/user/repo/main/book/book_book1/pic_book1/infographic_book1_2.png",
      "created_at": "2026-05-26T19:37:00",
      "completed_at": "2026-05-26T19:42:15"
    },
    {
      "sequence": 3,
      "prompt": "Visualize INFJ's \"Emotional Radar\" - how they sense others' feelings (use dots, waves)...",
      "task_id": "pqr567stu890",
      "artifact_id": "art345vwx678",
      "filename": "infographic_book1_3.png",
      "status": "completed",
      "github_url": "https://raw.githubusercontent.com/user/repo/main/book/book_book1/pic_book1/infographic_book1_3.png",
      "created_at": "2026-05-26T19:42:30",
      "completed_at": "2026-05-26T19:47:50"
    }
  ]
}
```
